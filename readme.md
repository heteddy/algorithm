...
1. [二叉搜索树中第K小的元素](https://github.com/heteddy/algorithm/tree/master/src/tree/kthsmall)
1. [是否二叉搜索树](https://github.com/heteddy/algorithm/tree/master/src/tree/bst)
1. [是否镜像/对称二叉树](https://github.com/heteddy/algorithm/tree/master/src/tree/symmetric)
